...
TWITTER_CONFIG = {
    'max_posts_per_day': 15,  # Maximum par compte
    'accounts_count': 2,      # Nombre de comptes
    'post_interval_minutes': 90,  # 90 minutes entre posts par compte
    'alternating_interval_minutes': 45,  # 45 minutes en alternant les comptes
